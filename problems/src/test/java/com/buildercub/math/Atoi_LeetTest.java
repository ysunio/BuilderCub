...
/**
 * Unit tests for Atoi_Leet
 * 
 * Problem Statement: Problem: Atoi Leet
...
class Atoi_LeetTest {
    ...
    @Test
    @DisplayName("Test myAtoi - basic functionality")
    void testMyatoi() {
        // TODO: Add test cases for myAtoi
